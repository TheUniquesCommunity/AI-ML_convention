...
export default function AnimatedSupportTeam() {
  ...
  return (
    <div className="mx-auto px-3 pt-16">
      <div className="flex flex-col md:flex-row justify-between items-center bg-white text-black relative overflow-y-hidden overflow-x-hidden pb-20">
        ...
        <div className="w-full md:w-2/5 py-10 text-center md:text-left">
          ...
          <p className="mt-6 text-lg text-gray-700 leading-relaxed lg:text-justify md:text-justify text-center">
        ...
        <div className="w-full md:w-3/5 flex justify-center items-center h-full px-4 py-8 relative mt-10">
              ...
              >
                ...
                {hoveredStaff?.id === staff.id && (
                  <motion.div
                    ...
                    className="absolute right-full ml-4 top-0 bg-white p-4 rounded-lg shadow-lg z-[1000000] w-64"
                  >
