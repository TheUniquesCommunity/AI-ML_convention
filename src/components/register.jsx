...
function App() {
  ...
  return (
    <div className="min-h-screen flex  items-center justify-center p-4 pt-16">
      <div className="w-full max-w-5xl grid grid-cols-5 rounded-lg overflow-hidden shadow-xl">
        {/* Left side content */}
        <div className='lg:col-span-2 md:col-span-2 col-span-5'>
          <div className="bg-[#a01c1c] text-white p-8 h-full  flex items-center">
        ...
        {/* Right side form */}
        <div className='lg:col-span-3 md:col-span-3 col-span-5 order-last'>
